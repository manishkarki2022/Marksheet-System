...
@section('content')
    ...
    <div class="flex-1 overflow-x-hidden overflow-y-auto p-4">
        ...
        <a class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-700 focus:outline-none focus:ring focus:border-blue-300 float-right mb-0.5" href="{{route('subjects.create')}}">
           Add Subject
        </a>
            ...
            @foreach($subjects as $subject)
                <tr>
                    ...
                    <td class="py-2 px-4 border-b">
                        <a href="{{ route('subjects.show', $subject->id) }}" class="text-blue-500 hover:underline">View</a>
                        <a href="{{ route('subjects.edit', $subject->id) }}" class="text-green-500 hover:underline ml-2">Edit</a>
